...
do iatom=1, Noh,2
do you=1, 180
if(angle2(iatom,istep) .ge. (you-1) .and. angle2(iatom,istep) .lt. (you) .and. &
        &sqrt((ocoord(1,iatom,istep)*ocoord(1,iatom,istep))+(ocoord(3,iatom,istep)*&
        &ocoord(3,iatom,istep))) .ge. 4.0 .and. &
        &sqrt((ocoord(1,iatom,istep)*ocoord(1,iatom,istep))+(ocoord(3,iatom,istep)*&
...
!do iatom=1, Noh,2
!do you=1, 180
!if(angle2(iatom,istep) .ge. (you-1) .and. angle2(iatom,istep) .lt. (you)) then
...
!do idum1=1,180
! do idum2=1,180
!      if(highest .lt. angle(idum1,idum2)) then
!             highest=angle(idum1,idum2)
!     end if
!     end do
!     end do
...
do idum1=1,180
do idum2=1,180
        if (idum2 .gt. idum1) then
                angle(idum2,idum1)=angle(idum2,idum1)+angle(idum1,idum2)
                angle(idum1,idum2)=0
        end if
        end do
        end do
...
open(61, file="angular.dat")
do idum1=1,180
do idum2=1,180
      print*, angle(idum1,idum2)
!      if(highest .gt. 0) then
!      angle(idum1,idum2)=angle(idum1,idum2)!/highest
!      end if
      write(61,*) ((idum1)-1), ((idum2)-1), angle(idum1,idum2)/highest 
      end do
      end do
close(61)


!open(62, file="nope.dat")
!do idum1=1,180
!        write(62,*) idum1-1, mittel(idum1)
!        end do
!close(62)
