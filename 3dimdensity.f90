...
real(8)                 ::density(0:300)
real(8)              ::         statistic(0:300)
 ...
 do iatom=1, h2o_atoms, 3
   do iradius=0,150
     if(sqrt((h2o_coord(1,iatom,istep)*h2o_coord(1,iatom,istep))+&
             &(h2o_coord(2,iatom,istep)*h2o_coord(2,iatom,istep))) .le. (iradius*0.1)) then 
...
do iradius=1, 150
        density(iradius)=((((statistic(iradius)-statistic(iradius-1))/6.022E+023)*&
                &18.0152)/((((iradius*iradius)-((iradius-1)*(iradius-1)))*3.14*14.32*1.0E-24)))
        print*, density(iradius), (statistic(iradius)-statistic(iradius-1))
        write(58,*) iradius, density(iradius)/Nstep
        end do
...
!print*, (((26*18.0152)/6.022E+23)/(24*3.14*14.32*1.0E-024))
